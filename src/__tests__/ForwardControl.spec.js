...
describe('ForwardControl', () => {
  ...
  it('should render with "video-react-forward-control" class', () => {
    ...
    const buttonElement = container.querySelector('button.video-react-forward-control');
    expect(buttonElement).toBeInTheDocument();
  });
  ...
  it('should render with "video-react-icon-forward-5" class for forward 5 seconds', () => {
    ...
    const buttonElement = container.querySelector('button.video-react-icon-forward-5');
    expect(buttonElement).toBeInTheDocument();
  });
  ...
  it('should render with "video-react-icon-forward-10" class for forward 10 seconds', () => {
    ...
    const buttonElement = container.querySelector('button.video-react-icon-forward-10');
    expect(buttonElement).toBeInTheDocument();
  });
  ...
  it('should render with "video-react-icon-forward-30" class for forward 30 seconds', () => {
    ...
    const buttonElement = container.querySelector('button.video-react-icon-forward-30');
    expect(buttonElement).toBeInTheDocument();
  });
});
